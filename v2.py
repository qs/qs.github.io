...
config = {
    ...
    'ctypes': {
        'index': {'name': u"Random notes", 'icon': '', 'url': '{year}/{month}/{day}/{slug}.html'},
        'book': {'name': u"Books I read", 'icon': '', 'url': '{ctype}/{year}/{month}/{slug}.html'},
        'event': {'name': u"Events I visited", 'icon': '', 'url': '{ctype}/{year}/{month}/{slug}.html'},
        'guide': {'name': u"Guides I wrote", 'icon': '', 'url': '{ctype}/{slug}.html'},
    }
}
